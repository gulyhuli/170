    ...
    .then(user => {
      switch (msg.data) {
        ...
        case 'morePrice g_high':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => PageController.changePagePrice(user, 'content', 'add', msg.data))
          break
        ...
        case 'lessPrice g_high':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => PageController.changePagePrice(user, 'content', 'remove', msg.data))
          break
        ...
        case 'startPrice g_high':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => PageController.changePagePrice(user, 'content', 'reset', msg.data))
          break
